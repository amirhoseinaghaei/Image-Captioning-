...
# tf.keras.applications.inception_v3.InceptionV3 , preprocess_input
...
class preprocessing():
	...
	def create_sequences_for_testing(self, tokenizer, max_length, descriptions, photos, vocab_size):
